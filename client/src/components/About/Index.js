    ...
    <div className="about_container" id="about">
      ...
      <div>
        <p class="about_text">
          ...
          a career. It was until after writing my first few lines of code and
          eventually getting it to run successfully after some tries, I finally
          saw the output of what I have built. This sheer excitement I felt
